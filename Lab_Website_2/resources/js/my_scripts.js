...
function loadStatsPage()
{
	...
	var row_counter;
	var buffWon = 0;
	var buffLost = 0; //Keeps track of our row index
	...
	document.getElementById("wins").innerHTML = buffWon;
	document.getElementById("losses").innerHTML = buffLost;
}
function loadPlayersPage()
{
	...
	{
		temp+= '<a href="#" onclick = "switchPlayers('+i+')" > '+players[i].name+' </a><br/>';
	}
...
{
	var player_index = 0;
	if(playerNum == 0) document.getElementById("player_img").src = "../resources/img/player1.jpg";
	if(playerNum == 1) document.getElementById("player_img").src = "../resources/img/player2.jpg";
	if(playerNum == 2) document.getElementById("player_img").src = "../resources/img/player3.jpg";
	if(playerNum == 3) document.getElementById("player_img").src = "../resources/img/player4.jpg";
	...
	document.getElementById('p_yards').innerHTML = players[playerNum].passing_yards;
